...
@implementation CPWithdrawRecordVC
...
- (IBAction)titleButtonAction:(id)sender {
    ...
    [CPSelectedOptionsAgoView showWithOnView:self.navigationController.view title:@"选择提款类型" options:_typeList selectedIndex:self.selectedType selected:^(NSInteger index) {
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell addWithdrawRecordInfo:info];
    return cell;
}
...
-(void)queryDetailInfoWithId:(NSString *)infoId
{
    ...
    [SUMRequest startWithDomainString:[CPGlobalDataManager shareGlobalData].domainUrlString
                              apiName:CPSerVerAPINameForAPIUserWithdrawDetail
           ...
           completionBlockWithSuccess:^(__kindof SUMRequest *request) {
               ...
               if (request.resultIsOk) {
                   ...
                   CPWithdrawDetailVC *vc = [CPWithdrawDetailVC new];
                   vc.withdrawInfo = info;
                   [self.navigationController pushViewController:vc animated:YES];
...
-(void)queryDataForReferesh
{
    ...
    NSString *paramsString = [NSString encryptedByGBKAES:[paramsDic JSONString]];
    [SUMRequest startWithDomainString:[CPGlobalDataManager shareGlobalData].domainUrlString
                              apiName:CPSerVerAPINameForAPIUserWithdrawList
                               params:@{@"data":paramsString}
                         rquestMethod:YTKRequestMethodGet
           completionBlockWithSuccess:^(__kindof SUMRequest *request) {
