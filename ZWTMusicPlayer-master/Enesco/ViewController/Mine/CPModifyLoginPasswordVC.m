...
-(void)queryVerify
{
    ...
    NSMutableDictionary *paramsDic =[[NSMutableDictionary alloc]initWithDictionary:@{@"oPasswd":_tfUserName.text,@"passwd":_tfQuestion.text,@"nPasswd":_tfAnswer.text,@"token":[SUMUser shareUser].token}];
    ...
    [SUMRequest startWithDomainString:[CPGlobalDataManager shareGlobalData].domainUrlString
                              apiName:CPSerVerAPINameForAPISettingLoginPasswd
