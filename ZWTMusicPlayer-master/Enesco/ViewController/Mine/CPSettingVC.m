...
-(void)queryLogout
{
    ...
    [SUMRequest startWithDomainString:[CPGlobalDataManager shareGlobalData].domainUrlString
                              apiName:CPSerVerAPINameForAPILogout
...
-(void)querySettingInfo
{
    ...
    NSString *paramsString = [NSString encryptedByGBKAES:[paramsDic JSONString]];
    [SUMRequest startWithDomainString:[CPGlobalDataManager shareGlobalData].domainUrlString
                              apiName:CPSerVerAPINameForAPISetting
                               params:@{@"data":paramsString}
                         rquestMethod:YTKRequestMethodGet
           completionBlockWithSuccess:^(__kindof SUMRequest *request) {
...
-(void)queryAboutUsMessage
{
    ...
    [SUMRequest startWithDomainString:[CPGlobalDataManager shareGlobalData].domainUrlString
                              apiName:CPSerVerAPINameForAPISettingAboutUs
                               params:@{@"data":paramsString}
                         rquestMethod:YTKRequestMethodGet
           completionBlockWithSuccess:^(__kindof SUMRequest *request) {
...
-(void)queryGetQa
{
    ...
    [SUMRequest startWithDomainString:[CPGlobalDataManager shareGlobalData].domainUrlString
                              apiName:CPSerVerAPINameForAPISettingGetQa
                               params:@{@"data":paramsString}
                         rquestMethod:YTKRequestMethodGet
           completionBlockWithSuccess:^(__kindof SUMRequest *request) {
...
-(void)queryIsWithdrawPasswdSet
{
    ...
    [SUMRequest startWithDomainString:[CPGlobalDataManager shareGlobalData].domainUrlString
                              apiName:CPSerVerAPINameForAPISettingIsWithdrawPasswdSet
                               params:@{@"data":paramsString}
                         rquestMethod:YTKRequestMethodGet
           completionBlockWithSuccess:^(__kindof SUMRequest *request) {
