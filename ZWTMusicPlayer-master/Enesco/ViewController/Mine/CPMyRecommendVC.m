...
/*
    ...
    */
    ...
    NSInteger memberId = [[SUMUser shareUser].tokenInfo.memberId integerValue];
    memberId = memberId+100000;
    _myRecommendIdLabel.text = [NSString stringWithFormat:@"%ld",memberId];
    _myRecommendAddressTv.text = [[CPGlobalDataManager shareGlobalData].domainUrlString wayStringByAppendingPathComponent:[NSString stringWithFormat:@"/common/register?tjr=%ld",memberId]];
...
-(void)queryMyRecommendInfo
{
    ...
    [SUMRequest startWithDomainString:[CPGlobalDataManager shareGlobalData].domainUrlString
                              apiName:CPSerVerAPINameForAPIUserSpread
