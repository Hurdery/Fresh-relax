...
-(void)queryVerify
{
    ...
    NSMutableDictionary *paramsDic =[[NSMutableDictionary alloc]initWithDictionary:@{@"question":_tfUserName.text,@"answer":_tfQuestion.text,@"nAnswer":_tfAnswer.text,@"token":[SUMUser shareUser].token}];
