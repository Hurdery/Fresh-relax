...
-(void)queryRbankListIsInit:(BOOL)isInit
{
    ...
    [SUMRequest startWithDomainString:[CPGlobalDataManager shareGlobalData].domainUrlString
                              apiName:CPSerVerAPINameForAPIUserRbankList
...
-(void)queryRonlineList
{
    ...
    NSString *paramsString = [NSString encryptedByGBKAES:[paramsDic JSONString]];
    [SUMRequest startWithDomainString:[CPGlobalDataManager shareGlobalData].domainUrlString
                              apiName:CPSerVerAPINameForAPIUserRonlineList
                               params:@{@"data":paramsString}
                         rquestMethod:YTKRequestMethodGet
           completionBlockWithSuccess:^(__kindof SUMRequest *request) {
...
-(void)queryRqqpayList
{
    ...
    NSString *paramsString = [NSString encryptedByGBKAES:[paramsDic JSONString]];
    [SUMRequest startWithDomainString:[CPGlobalDataManager shareGlobalData].domainUrlString
                              apiName:CPSerVerAPINameForAPIUserRqqpayList
                               params:@{@"data":paramsString}
                         rquestMethod:YTKRequestMethodGet
           completionBlockWithSuccess:^(__kindof SUMRequest *request) {
...
-(void)queryRotherList
{
    ...
    NSString *paramsString = [NSString encryptedByGBKAES:[paramsDic JSONString]];
    [SUMRequest startWithDomainString:[CPGlobalDataManager shareGlobalData].domainUrlString
                              apiName:CPSerVerAPINameForAPIUserRotherList
                               params:@{@"data":paramsString}
                         rquestMethod:YTKRequestMethodGet
           completionBlockWithSuccess:^(__kindof SUMRequest *request) {
...
-(void)queryRwechatList
{
    ...
    NSString *paramsString = [NSString encryptedByGBKAES:[paramsDic JSONString]];
    [SUMRequest startWithDomainString:[CPGlobalDataManager shareGlobalData].domainUrlString
                              apiName:CPSerVerAPINameForAPIUserRwechatList
                               params:@{@"data":paramsString}
                         rquestMethod:YTKRequestMethodGet
           completionBlockWithSuccess:^(__kindof SUMRequest *request) {
...
-(void)queryRalipayList
{
    ...
    NSString *paramsString = [NSString encryptedByGBKAES:[paramsDic JSONString]];
    [SUMRequest startWithDomainString:[CPGlobalDataManager shareGlobalData].domainUrlString
                              apiName:CPSerVerAPINameForAPIUserRalipayList
                               params:@{@"data":paramsString}
                         rquestMethod:YTKRequestMethodGet
           completionBlockWithSuccess:^(__kindof SUMRequest *request) {
...
-(void)queryNextBankInfo
{
    ...
    NSString *paramsString = [NSString encryptedByGBKAES:[paramsDic JSONString]];
    [SUMRequest startWithDomainString:[CPGlobalDataManager shareGlobalData].domainUrlString
                              apiName:CPSerVerAPINameForAPIUserRbankNext
                               params:@{@"data":paramsString}
                         rquestMethod:YTKRequestMethodGet
           completionBlockWithSuccess:^(__kindof SUMRequest *request) {
...
-(void)queryNextQQPay
{
    ...
    [paramsDic setObject:[CPGlobalDataManager shareGlobalData].domainUrlString forKey:@"baseUrl"];
    
    NSString *paramsString = [NSString encryptedByGBKAES:[paramsDic JSONString]];
    [SUMRequest startWithDomainString:[CPGlobalDataManager shareGlobalData].domainUrlString
                              apiName:CPSerVerAPINameForAPIUserRqqpayNext
                               params:@{@"data":paramsString}
                         rquestMethod:YTKRequestMethodGet
           completionBlockWithSuccess:^(__kindof SUMRequest *request) {
...
-(void)queryNextOtherPay
{
    ...
    NSString *paramsString = [NSString encryptedByGBKAES:[paramsDic JSONString]];
    [SUMRequest startWithDomainString:[CPGlobalDataManager shareGlobalData].domainUrlString
                              apiName:CPSerVerAPINameForAPIUserRotherNext
                               params:@{@"data":paramsString}
                         rquestMethod:YTKRequestMethodGet
           completionBlockWithSuccess:^(__kindof SUMRequest *request) {
...
-(void)queryWechatScanNext
{
    ...
    NSString *paramsString = [NSString encryptedByGBKAES:[paramsDic JSONString]];
    [SUMRequest startWithDomainString:[CPGlobalDataManager shareGlobalData].domainUrlString
                              apiName:CPSerVerAPINameForAPIUserRwechatScanNext
                               params:@{@"data":paramsString}
                         rquestMethod:YTKRequestMethodGet
           completionBlockWithSuccess:^(__kindof SUMRequest *request) {
...
-(void)queryWechatThirdNext
{
    ...
    NSString *paramsString = [NSString encryptedByGBKAES:[paramsDic JSONString]];
    [SUMRequest startWithDomainString:[CPGlobalDataManager shareGlobalData].domainUrlString
                              apiName:CPSerVerAPINameForAPIUserWechatNext
                               params:@{@"data":paramsString}
                         rquestMethod:YTKRequestMethodGet
           completionBlockWithSuccess:^(__kindof SUMRequest *request) {
...
-(void)queryAlipayThirdNext
{
    ...
    NSString *paramsString = [NSString encryptedByGBKAES:[paramsDic JSONString]];
    [SUMRequest startWithDomainString:[CPGlobalDataManager shareGlobalData].domainUrlString
                              apiName:CPSerVerAPINameForAPIUserAlipayNext
                               params:@{@"data":paramsString}
                         rquestMethod:YTKRequestMethodGet
           completionBlockWithSuccess:^(__kindof SUMRequest *request) {
...
-(void)queryAlipayScanNext
{
    ...
    NSString *paramsString = [NSString encryptedByGBKAES:[paramsDic JSONString]];
    [SUMRequest startWithDomainString:[CPGlobalDataManager shareGlobalData].domainUrlString
                              apiName:CPSerVerAPINameForAPIUserRalipayScanNext
                               params:@{@"data":paramsString}
                         rquestMethod:YTKRequestMethodGet
           completionBlockWithSuccess:^(__kindof SUMRequest *request) {
...
-(void)queryWechatToBankCardNext
{
    ...
    NSString *paramsString = [NSString encryptedByGBKAES:[paramsDic JSONString]];
    [SUMRequest startWithDomainString:[CPGlobalDataManager shareGlobalData].domainUrlString
                              apiName:CPSerVerAPINameForAPIUserWechatBankNext
                               params:@{@"data":paramsString}
                         rquestMethod:YTKRequestMethodGet
           completionBlockWithSuccess:^(__kindof SUMRequest *request) {
...
-(void)queryAlipayToBankCardNext
{
    ...
    NSString *paramsString = [NSString encryptedByGBKAES:[paramsDic JSONString]];
    [SUMRequest startWithDomainString:[CPGlobalDataManager shareGlobalData].domainUrlString
                              apiName:CPSerVerAPINameForAPIUserRalipayBankNext
                               params:@{@"data":paramsString}
                         rquestMethod:YTKRequestMethodGet
           completionBlockWithSuccess:^(__kindof SUMRequest *request) {
                                            ...
                                            bankName:(NSString *)bankName
{
    ...
    NSString *urlString = [payUrl stringByAppendingString:[NSString stringWithFormat:@"/common/recharge/third?isH5=1&memberId=%@&type=%@&payId=%@&amount=%@%@%@&baseUrl=%@",[SUMUser shareUser].tokenInfo.memberId,type,payId,amount,bankName.length>0?@"&bankName=":@"",bankName.length>0?bankName:@"",domainString]];
                    ...
                    case CPRechargeByWechat:
                    {
                        ...
                        if ([code isEqualToString:@"#scan#"]) {
                            ...
                            if (payType == 2) {
                                ...
                                vc.type = 1;
                                [vc addTitleText:[info DWStringForKey:@"payName"] detailText:[NSString stringWithFormat:@"微信账号:%@ 微信昵称:%@",[info DWStringForKey:@"code"],[info DWStringForKey:@"name"]] imageUrlString:[[CPGlobalDataManager shareGlobalData].domainUrlString wayStringByAppendingPathComponent:[info DWStringForKey:@"payImg"]]];
                    ...
                    case CPRechargeByAlipay:
                    {
                        ...
                        if ([code isEqualToString:@"#scan#"]) {
                            ...
                            if (payType == 2) {
                                ...
                                CPAddFriendRechargeVC *vc = [CPAddFriendRechargeVC new];
                                vc.type = 0;
                                [vc addTitleText:[info DWStringForKey:@"payName"] detailText:[NSString stringWithFormat:@"支付宝账号:%@ 支付宝名称:%@",[info DWStringForKey:@"code"],[info DWStringForKey:@"name"]] imageUrlString:[[CPGlobalDataManager shareGlobalData].domainUrlString wayStringByAppendingPathComponent:[info DWStringForKey:@"payImg"]]];
                                dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(0.0 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
                                    vc.navigationItem.rightBarButtonItems = [self theSameRightBarButtonItems];
                                });
                                [self.navigationController pushViewController:vc animated:YES];
