...
-(void)queryResetPassword
{
    ...
    NSMutableDictionary *paramsDic =[[NSMutableDictionary alloc]initWithDictionary:@{@"password1":_tfPassword.text,@"password":_tfPasswordVerify.text,@"token":[SUMUser shareUser].token}];
...
//YTKRequestMethodGET
    ...
    [SUMRequest startWithDomainString:[CPGlobalDataManager shareGlobalData].domainUrlString
                              apiName:CPSerVerAPINameForAPIPasswordReset
