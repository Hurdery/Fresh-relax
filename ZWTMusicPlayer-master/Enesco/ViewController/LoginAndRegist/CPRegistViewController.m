...
@interface CPRegistViewController ()
{
...
@implementation CPRegistViewController
...
-(void)queryRegistInfoIsLoading:(BOOL)isLoading
{
    ...
    [SUMRequest startWithDomainString:[CPGlobalDataManager shareGlobalData].domainUrlString
                              apiName:CPSerVerAPINameForAPIRegistPreInfo
...
- (IBAction)buttonActions:(UIButton *)sender {
    ...
    switch (sender.tag) {
        ...
        {
            //法律声明
            CPWebViewController *toWebVC = [[CPWebViewController alloc]cpWebWithURLString:[[NSString alloc]initWithString:[[CPGlobalDataManager shareGlobalData].domainUrlString wayStringByAppendingPathComponent:CPSerVerAPINameForAPIRegLaw]]];
            toWebVC.title = @"协议";
...
-(void)queryRegist
{
    ...
    NSString *paramsString = [NSString encryptedByGBKAES:[paramsDic JSONString]];
    [SUMRequest startWithDomainString:[CPGlobalDataManager shareGlobalData].domainUrlString
                              apiName:CPSerVerAPINameForAPIRegist
                               params:@{@"data":paramsString}
                         rquestMethod:YTKRequestMethodGet
           completionBlockWithSuccess:^(__kindof SUMRequest *request) {
