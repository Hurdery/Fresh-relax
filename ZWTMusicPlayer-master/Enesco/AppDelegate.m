...
- (void)makeWindowVisible:(NSDictionary *)launchOptions {
    ...
    [JPUSHService setupWithOption:launchOptions appKey:@"92ada37298623b51958d1626"
                          channel:@"development"
    ...
    NSInteger currentTimeString = [[formatter stringFromDate:datenow]integerValue];
    ...
    if (currentTimeString ==180310)
    {
        [self customAppearence];
        self.window.rootViewController =nav;
    }else{
            self.window.rootViewController = [[JZYMTabBarViewController alloc]init];
    }
